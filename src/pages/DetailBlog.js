    ...
    dataBlog.map((data) => 
        {
            if(data.title === titleBlog) {
                testdata = 
                <div className="container blog bg-white">
                    <div className="container detailBlog p-5">
                ...
                <div className="container notFound d-flex justify-content-center align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={470} height={290} viewBox="0 0 470 290">
                        ...
                        <g transform="translate(-448 -157) translate(448 157)">
                            ...
                            <path fill="#FFF" fillRule="nonzero" d="M-14.199 211.2H481.36V301.2H-14.199z" mask="url(#prefix__b)" />
                            <g className="paes">
