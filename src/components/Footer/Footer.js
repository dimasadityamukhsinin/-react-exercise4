        ...
        <footer className="bg-white">
            <div className="container-fluid p-5 text-center">
                <div className="d-flex justify-content-end align-items-center">
                    <h5 className="mr-2">FOLLOW <span>@impactbyte</span></h5>
                ...
                <div className="row d-flex justify-content-between align-items-end">
                    <div>
                        <img src="https://impactbyte.com/static/brand/impactbyte_horizontal_color-trans.svg" style={{height: "3.5rem"}} alt="Impact Byte"/>
                    </div>
                    <div>
                        <ul className="d-flex">
                            <li className="mr-4">
                                <a className="impactbyte" href="/">Impactbytejobs.com</a>
                            </li>
                            <li className="mr-4">
                                <a className="item-footer" href="/">Privacy</a>
                            </li>
                            <li className="mr-4">
                                <a className="item-footer" href="/">Cookie Preferences</a>
                            </li>
                            <li className="mr-4">
                                <a className="item-footer" href="/">Help Center</a>
                            </li>
                        </ul>
                    </div>
                </div>
